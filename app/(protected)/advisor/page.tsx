    ...
    <div className="flex h-full" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            sessions?.map(session => (
              ...
              >
                <span
                  ...
                  style={{ color: activeSessionId === session.id ? '#00c4cc' : '#64748b' }}
                >
      ...
      <div className="flex-1 flex flex-col relative">
        <div className="px-6 py-4 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          <div className="flex items-center gap-2">
            <span className="material-icons" style={{ color: '#00c4cc', fontSize: '20px' }}>smart_toy</span>
            <h1 className="text-base font-semibold" style={{ color: '#f1f5f9' }}>AI Advisor</h1>
            {isPending && (
              <span className="text-xs ml-2 px-2 py-0.5 rounded-full" style={{ background: 'rgba(0,196,204,0.1)', color: '#00c4cc' }}>
                ● responding
              </span>
            )}
          </div>
